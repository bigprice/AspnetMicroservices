...
namespace Ordering.Application.Features.Orders.Commands.CheckoutOrder
{
    public class CheckoutOrderCommandHandler : IRequestHandler<CheckoutOrderCommand, int>
    {
        ...
        {
            var email = new Email() { To = "bigangelito@gmail.com", Body = $"Order was created: {newOrder.Id}.", Subject = "Order was created" };
            ...
            {
                _logger.LogError($"Order { newOrder.Id} failed due to an error with de email service: {ex.Message}");
            }
        }
    }
}
